...
export function Projects() {
  const projects = [
    {
      title: 'Audience OS – Website Analytics & Engagement Platform',
      description:
        'A self-serve website analytics and audience-engagement platform where users create projects and embed a lightweight tracking script on their websites. Features a real-time analytics dashboard with page-view tracking, heatmaps, funnel analysis, and newsletter/waitlist capture modules with self-managed data storage.',
      technologies: ['React.js', 'Supabase', 'Real-Time Analytics', 'Heatmaps'],
      github: 'https://audienceoss.vercel.app/',
      highlights: [
        'Lightweight tracking script & real-time analytics',
        'Heatmaps & funnel drop-off analysis',
        'Self-managed newsletter & waitlist capture',
      ],
    },
    {
